                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="app-top-items">
                            ...
                            <div class="app-top-right-link">
                                New to Barren?<a class="sidebar-register-link" href="{{route('org-signup')}}">Sign up</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6 col-md-7">
                        <div class="registration">
                            <form method="POST" id="user_signin">
                                @csrf
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group mt-4">
                                        ...
                                        <div class="input-group h_50">
                                            ...
                                            <div class="input-group-append" id="generateOTP">
                                                <button class="btn " type="button" onclick=GenerateOTP() style="color: #03A9f4">
                                                    <i class="fa-solid fa-mobile-retro"></i> Get OTP
                                                </button>
                                            </div>
                                            <div class="input-group-append" id="generateNew" hidden>
                                                <button class="btn " type="button" onclick=GenerateOTP() style="color: #03A9f4">Generate New</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mt-4" hidden>
                                        {{-- OTP has been sent to the registered mobile no. --}}
                                        <p></p>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12" id="enter-otp" hidden>
                                        <div class="form-group mt-4">
                                            <div class="input-group h_50">
                                                <input class="form-control" name="OTP" id="OTP" type="text" placeholder="Enter OTP..." value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <button class="main-btn btn-hover w-100 mt-4" type="submit">Sign In</button>
                                    </div>
                                </div>
                            </form>
                            <div class="divider">
...
$('#user_signin').on('submit', function (event) {
