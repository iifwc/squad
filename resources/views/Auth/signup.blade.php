...
<body>
                        ...
                        <div class="col-lg-10 col-md-10">
                            <div class="app-top-items">
                                ...
                                <div class="app-top-right-link">
                                    Already have an account?<a class="sidebar-register-link" href="{{route('signin')}}">Sign In</a>
                                </div>
                            </div>
                        </div>
    ...
    icon: 'success',
    title: 'OTP',
    text: "OTP sent successfully", // Parse JSON and access message property
