...
<body class="d-flex flex-column h-100">
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="form-group mt-4">
									...
									<textarea class="form-textarea" placeholder="Bio"></textarea>																							
								</div>
							</div>
	...
	<!-- Header Start-->
	@include('org.orgheader')
	<!-- Header End-->
	<!-- Left Sidebar Start -->
	@include('org.orgsidebar')
	<!-- Left Sidebar End -->
	<!-- Body Start -->
                        ...
                        <div class="main-card mt-5">
                            ...
                            <div class="about-details">
                                    ...
                                    <div class="user-avatar-img">
                                        @if ($users->isNotEmpty())
                                            @foreach ($users as $user)
                                                ...
                                                <div class="user-dts">
                                                    @if($user->Name)
                                                        <h4 class="user-name">{{$user->Name}}<span class="verify-badge"><i class="fa-solid fa-circle-check"></i></span></h4>
                                                    @endif
                                                    @if($user->Email)
                                            ...
                                            @endforeach <!-- Closing foreach loop here -->
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="about-step">
									...
									@if($user->Facebook)
											<a href="{{$user->Facebook}}" class="social-link" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Facebook" aria-label="Facebook"><i class="fab fa-facebook-square"></i></a>
									@elseif($user->Instagram)
											<a href="{{$user->Instagram}}" class="social-link" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Instagram" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
									@elseif($user->Twitter)
											<a href="{{$user->Twitter}}" class="social-link" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Twitter" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
									@elseif($user->LinkedIn)
											<a href="{{$user->LinkedIn}}" class="social-link" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="LinkedIn" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
									@elseif($user->Youtube)
											<a href="{{$user->Youtube}}" class="social-link" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Youtube" aria-label="Youtube"><i class="fab fa-youtube"></i></a>
									@elseif($user->Website)
											<a href="{{$user->Website}}" class="social-link" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Website" aria-label="Website"><i class="fa-solid fa-globe"></i></a>
									@else
									<p> we not provide social-links</p>
									@endif
                                ...
                                <div class="about-step">
                                    ...
                                    @else
                                        <p class="mb-0">Address not provided</p>
                                    @endif
                                </div>
                            </div>
                        </div>
