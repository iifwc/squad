						...
						<div class="main-card add-organisation-card p-4 mt-5">
							<div class="ocard-left">
								...
								<div class="ocard-name">
									<h4>Swastik Event PVT. LTD.</h4>
									<span>Music and Concert</span>
								</div>
							</div>
										...
										<div class="col-xl-3 col-lg-6 col-md-6">
											<div class="dashboard-report-card purple">
												<div class="card-content">
													<div class="card-content">
														<span class="card-title fs-6">Revenue (INR)</span>
														<span class="card-sub-title fs-3">₹1048550.00</span>
														<div class="d-flex align-items-center">
															<span><i class="fa-solid fa-arrow-trend-up"></i></span>
															<span class="text-Light font-12 ms-2 me-2">19.90%</span>
											...
											<div class="dashboard-report-card red">
												<div class="card-content">
													<div class="card-content">
														...
														<span class="card-sub-title fs-3">29823</span>
														<div class="d-flex align-items-center">
															<span><i class="fa-solid fa-arrow-trend-up"></i></span>
															<span class="text-Light font-12 ms-2 me-2">15.00%</span>
															<span class="font-12 color-body text-nowrap">From Previous Period</span>
														</div>
													</div>
													<div class="card-media">
											...
											<div class="dashboard-report-card info">
												<div class="card-content">
													<div class="card-content">
														...
														<span class="card-sub-title fs-3">69230</span>
														<div class="d-flex align-items-center">
															<span><i class="fa-solid fa-arrow-trend-up"></i></span>
															<span class="text-Light font-12 ms-2 me-2">40.69%</span>
															<span class="font-12 color-body text-nowrap">From Previous Period</span>
														</div>
													</div>
													<div class="card-media">
											...
											<div class="dashboard-report-card success">
												<div class="card-content">
													<div class="card-content">
														...
														<span class="card-sub-title fs-3">30789</span>
														<div class="d-flex align-items-center">
															<span><i class="fa-solid fa-arrow-trend-up"></i></span>
															<span class="text-Light font-12 ms-2 me-2">17.85%</span>
															<span class="font-12 color-body text-nowrap">From Previous Period</span>
														</div>
													</div>
													<div class="card-media">
