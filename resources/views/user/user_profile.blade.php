                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mt-4">
                                        ...
                                        <input class="form-control h_40" type="text" name="Name"
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mt-4">
                                        ...
                                        <input class="form-control h_40" type="email" name="Email"
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group mt-4">
                                        ...
                                        <textarea class="form-textarea" name="Bio" id="Bio" placeholder=""></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mt-4">
                                        ...
                                        <input class="form-control h_40" type="text" name="Age"
                                            id="Age" placeholder="" value="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group mt-4 ">
                                        <label class="form-label">Gender*</label>
                                        <select name="Gender" id="Gender" class="form-control h_40">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-12">
                            <div class="main-card user-left-dt">
                                ...
                                <div class="user-dts">
                                    <h4 class="user-name user_name" id="user_name"><span class="verify-badge"><i
                                ...
                                <div class="user-description">
                                    <p>Hey I am  <span class="user_name">Name</span></p>
                                </div>
                                {{-- <div class="user-btns">
                                                            ...
                                                            <div class="main-card mt-4">
                                                                <div class="card-top p-4">
                                                                    ...
                                                                    <div class="card-event-dt">
                                                                        ...
                                                                        <div class="evnt-time">Thu, Jun 30, 2022 4:30
                                                                            AM</div>
                                                            ...
                                                            <div class="main-card mt-4">
                                                                <div class="card-top p-4">
                                                                    ...
                                                                    <div class="card-event-dt">
                                                                        ...
                                                                        <div class="evnt-time">Sun, Jul 17, 2022 5:30
                                                                            AM</div>
                                                                        <div class="event-btn-group">
                                                                            <button class="esv-btn me-2"
                                                                                onclick="window.location.href='create_online_event.html'"><i
                                                                ...
                                                                <div class="profile-setting p-4">
                                                                    ...
                                                                    <div class="setting-step pt-4">
                                                                        ...
                                                                        <p class="mt-1 mb-4">Get updates on new
                                                                            features and insights so that you can make
                                                                            the best use of Barren.</p>
                                                                    </div>
                                                                    <div class="setting-step pt-4">
                                                                        <div
                                                                            class="d-flex align-items-center justify-content-between">
                                                                        ...
                                                                        <p class="mt-1 mb-4">Get more insights on
                                                                            Barren that can help to boost your event
                                                                            business.</p>
                                                                    </div>
                                                                    <div class="setting-step pt-4">
                                                                        <div
                                                                ...
                                                                <div class="privacy-setting p-4">
                                                                    ...
                                                                    <div class="setting-step pt-4">
                                                                        ...
                                                                        <p class="mt-1 mb-4">People will be able to
                                                                            send you emails through Barren who visits
                                                                            your profile</p>
                                                                    </div>
                                                                    <div class="setting-step pt-4">
                                                                        <div
...
$(document).ready(function() {
    var apiUrl = "{{ $Api_url }}"; // Accessing the apiUrl variable passed from the controller
    ...
    $.ajax(settings).done(function(response) {
        ...
        console.log(data);
            ...
            for (var i = 0; i < userNameElements.length; i++) {
                userNameElements[i].innerText = value.Name;
            }
            // Check if email exists before populating
            if (value.Email) {
                document.getElementById('user_email').innerText = value.Email;
            } else {
                document.getElementById('user_email').innerText = "Email not provided";
            }
        });
    });
});
